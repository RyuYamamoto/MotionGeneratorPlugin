...
//	腰 -> 右足先
	...
	{{  0.0f,   0.0f,-245.0f},{  0.0f,  1.0f,  0.0f}},	// RP2 : 右膝上ピッチ軸から右膝下ピッチ軸
	{{  0.0f,   0.0f, -41.0f},{  0.0f,  1.0f,  0.0f}},	// RP3 : 右膝下ピッチ軸から右足首ピッチ軸
	{{  0.0f,   0.0f,-245.0f},{  0.0f,  1.0f,  0.0f}},	// RP4 : 右足首ピッチ軸から右足首ロール軸
...
//	腰 -> 左足先
	...
	{{  0.0f,   0.0f,-245.0f},{  0.0f,  1.0f,  0.0f}},	// LP2 : 左膝上ピッチ軸から左膝下ピッチ軸
	{{  0.0f,   0.0f, -41.0f},{  0.0f,  1.0f,  0.0f}},	// LP3 : 左膝下ピッチ軸から左足首ピッチ軸
	{{  0.0f,   0.0f,-245.0f},{  0.0f,  1.0f,  0.0f}},	// LP4 : 左足首ピッチ軸から左足首ロール軸
